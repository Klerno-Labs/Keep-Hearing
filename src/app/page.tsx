...
export default function Home() {
  ...
  <section className="w-full py-20 flex flex-col items-center justify-center bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl transition-all duration-500 hover:shadow-[var(--brand-primary)]/30">
        ...
        <p className="mt-3 text-2xl text-gray-700 text-center max-w-2xl">
  ...
  <div className="flex-1 space-y-12">
          <section className="rounded-2xl bg-white shadow-lg p-10 transition-all duration-300">
        ...
        <div className="flex flex-col items-center gap-10">
          ...
          <div className="w-56 h-56 flex items-center justify-center">
            <div className="w-full h-full rounded-full bg-[var(--brand-primary)] text-white flex flex-col items-center justify-center shadow-xl border-4 border-white text-center p-6" style={{ fontFamily: 'Inter, Arial, sans-serif', boxShadow: '0 8px 32px rgba(26,115,232,0.15)' }}>
      ...
      {/* Donate Section */}
  <section className="rounded-2xl bg-white/80 backdrop-blur-xl shadow-2xl p-12 mt-20 flex flex-col items-center transition-all duration-500 hover:shadow-blue-500/30">
  <h2 className="text-4xl font-bold mb-4 text-center text-[var(--brand-primary)]">Support Our Mission</h2>
        <p className="text-lg text-gray-700 mb-8 text-center max-w-xl">Your donation helps us expand hearing preventive care and education worldwide. 100% of donations go to nonprofit programs.</p>
  ...
  <section className="rounded-2xl bg-white/80 backdrop-blur-xl shadow-2xl p-12 mt-20 flex flex-col items-center transition-all duration-500 hover:shadow-[var(--brand-primary)]/30">
  <h2 className="text-4xl font-bold mb-4 text-center text-[var(--brand-primary)]">About Us & Impact</h2>
        <p className="text-lg text-gray-700 mb-6 text-center max-w-xl">Keep Hearing Initiative is a registered nonprofit dedicated to hearing health, education, and fair access. Since 2022, we've reached over 10,000 people and funded 3 major studies. Read our annual report for more details.</p>
  ...
  <h2 className="text-4xl font-bold mb-4 text-center text-[var(--brand-primary)]">Get Involved</h2>
        <p className="text-lg text-gray-700 mb-6 text-center max-w-xl">Interested in volunteering or partnering? Email us or fill out the form below.</p>
        ...
        <div className="mt-4 text-base text-gray-500">Or email: <a href="mailto:info@keephearing.org" className="text-[var(--brand-primary)] hover:underline">info@keephearing.org</a></div>
      </section>

      {/* Board/Team Section */}
  <section className="rounded-2xl bg-white/80 backdrop-blur-xl shadow-2xl p-12 mt-20 flex flex-col items-center transition-all duration-500 hover:shadow-[var(--brand-primary)]/30">
  <h2 className="text-4xl font-bold mb-4 text-center text-[var(--brand-primary)]">Our Team</h2>
        <ul className="list-none flex flex-col gap-4 text-lg text-gray-700">
  ...
  <h2 className="text-4xl font-bold mb-4 text-center text-[var(--brand-primary)]">Transparency & Legal</h2>
        <ul className="list-none flex flex-col gap-2 text-lg text-gray-700 mb-4">
        ...
        <p className="text-base text-gray-500">All financials and reports are available upon request.</p>
      </section>

      {/* Newsletter Signup */}
      <section className="rounded-2xl bg-white shadow-lg p-12 mt-20 flex flex-col items-center transition-all duration-300">
  ...
  <button type="submit" className="px-8 py-3 rounded-xl bg-[var(--brand-primary)] text-white font-semibold shadow-lg hover:shadow-[var(--brand-primary)]/40 transition hover:scale-105">Subscribe</button>
        </form>
      </section>
